        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch(opcionSubida){
                case "Ingresar Examen":
                    ...
                    if(examen.SubirArchivoParametros(codigo, nombre, order, descripcion, Double.parseDouble(costo), informe)){
                        out.println("<h1> Se Ingreso el examen de codigo "+codigo+"</h1>");
                    }else{
                        out.println("<h1> Formatos Incorrectos en el examen de codigo "+codigo+"</h1>");
                    }
                    break;    
                case "Ingresar Laboratorista":
                    ...
                    if(laboratorista.SubirArchivoParametros(codigoL, nombreL, dpiL, telefonoL, examenL, correoL, diasTrabajo, trabajoL,passwordL, registroL)){
                        out.println("<h1> Se Ingreso el laboratorista de codigo "+codigoL+"</h1>");
                    }else{
                        out.println("<h1> Formatos Incorrectos en el laboratorista de codigo "+codigoL+"</h1>");
                    }
                    break;    
                case "Ingresar Medico":
                    ...
                    if(medico.SubirArchivoParametros(codigoM, nombreM, dpiM, telefonoM, colegiadoM, especialidades, horarioInicio, horarioSalida,
                            passwordM, correoM, fecha)){
                        out.println("<h1> Se Ingreso el medico de codigo "+codigoM+"</h1>");
                    }else{
                ...
                case "Ingresar Paciente":
                    ...
                    if(paciente.SubirArchivoParametros(codigoP, nombreP, dpiP, telefonoP, sexoP, fechaNacimientoP, tipoSangreP, pesoP, passwordP, correoP)){
                        out.println("<h1> Se Ingreso el paciente de codigo "+codigoP+"</h1>");
                    }else{
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<a href="+"../adminMenuPage.jsp"+">Regresar</a>");
            }
        }
