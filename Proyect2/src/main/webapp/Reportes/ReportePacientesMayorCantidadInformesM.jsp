<%-- 
    Document   : ReportePacientesMayorCantidadInformes
    Created on : Oct 4, 2020, 9:58:42 AM
    Author     : camran1234
--%>
...
<html>
    ...
    <body>
        <h1>Pacientes Con Mayor Cantidad De Informes</h1>
        ...
        <table class="table table-borderless table-dark">
          ...
          <tbody>
              <%
                  ...
                  ArrayList<String> examenesPendientes = new MedicoQuery().ReportePacientesConMayorInformes(codigoMedico, fechaInicial, fechaFinal);
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              ...
              <li class="page-item">
                <a class="page-link" href="../Reportes/ReporteCitasDiaM.jsp">Anterior</a>
              </li>
