<%-- 
    Document   : MedicosConMasInformesA
    Created on : Oct 4, 2020, 1:31:22 PM
    Author     : camran1234
--%>
...
<html>
    ...
    <body>
        <h1>Medicos Con Mas Informes Solicitados<h1>
        
        <form method="get" action="../Reportes/MedicosConMasInformesA.jsp">        
        ...
        <table class="table table-borderless table-dark">
          ...
          <tbody>
              <%
                  ...
                  ArrayList<String> medicosInformes = new AdministradorQuery().ReporteMayorCantidadReportesMedico(fechaInicio, fechaFinal);
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              ...
              <li class="page-item disabled">
                <a class="page-link" href="../Reportes/MedicosConMasInformesA.jsp" aria-disabled="true" >Anterior</a>
              </li>
              ...
              <li class="page-item">
                <a class="page-link" href="../Reportes/MedicosExamensMasDemandadosA.jsp">Siguiente</a>
              </li>
            </ul>
        </nav>
