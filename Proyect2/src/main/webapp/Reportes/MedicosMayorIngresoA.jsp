<%-- 
    Document   : MedicosMayorIngreso
    Created on : Oct 4, 2020, 1:31:53 PM
    Author     : camran1234
--%>
...
<html>
    ...
    <body>
        <h1>Medicos Que Generan Mayor Ingreso<h1>
        
        <form method="get" action="../Reportes/MedicosMayorIngresoA.jsp">        
        ...
        <table class="table table-borderless table-dark">
          ...
          <tbody>
              <%
                  ...
                  ArrayList<String> medicosInformes = new AdministradorQuery().ReporteIngresoDoctor(fechaInicio, fechaFinal);
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              ...
              <li class="page-item">
                <a class="page-link" href="../Reportes/MedicosMayorExamenesRequeridosA.jsp" >Anterior</a>
              </li>
              ...
              <li class="page-item">
                <a class="page-link" href="../Reportes/MedicosMayorIngresoPacientesA.jsp">Siguiente</a>
              </li>
            </ul>
        </nav>
