<%-- 
    Document   : ReporteCitasAgendadasM
    Created on : Oct 4, 2020, 9:58:09 AM
    Author     : camran1234
--%>
...
<html>
    <head>
        ...
        <title>Citas Agendadas Page</title>
    </head>
    <body>
        <h1>Citas Agendadas Medico</h1>
        
        <form method="get" action="../Reportes/ReporteCitasAgendadasM.jsp">        
        ...
        <table class="table table-borderless table-dark">
          ...
          <tbody>
              <%
                  ...
                  ArrayList<String> examenesPendientes = new MedicoQuery().ReporteCitasAgendadas(codigoMedico, fechaInicial, fechaFinal);
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              ...
              <li class="page-item disabled">
                <a class="page-link" href="#" aria-disabled="true" >Anterior</a>
              </li>
              ...
              <li class="page-item"><a class="page-link" href="../Reportes/ReporteCitasDiaM.jsp">2</a></li>
              <li class="page-item"><a class="page-link" href="../Reportes/ReportePacientesMayorCantidadInformesM.jsp">3</a></li>
              <li class="page-item">
                <a class="page-link" href="../Reportes/ReporteCitasDiaM.jsp">Siguiente</a>
              </li>
            </ul>
        </nav>
