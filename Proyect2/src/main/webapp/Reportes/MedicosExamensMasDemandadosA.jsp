<%-- 
    Document   : MedicosExamensMasDemandados
    Created on : Oct 4, 2020, 1:32:33 PM
    Author     : camran1234
--%>
...
<html>
    ...
    <body>
        <h1>Examenes Mas Demandados<h1>
        
        <form method="get" action="../Reportes/MedicosExamensMasDemandadosA.jsp">        
        ...
        <table class="table table-borderless table-dark">
          ...
          <tbody>
              <%
                  ...
                  ArrayList<String> medicosInformes = new AdministradorQuery().ReporteExamenesMayoresDemandados(fechaInicio, fechaFinal);
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              ...
              <li class="page-item">
                <a class="page-link" href="../Reportes/MedicosConMasInformesA.jsp"  >Anterior</a>
              </li>
              ...
              <li class="page-item">
                <a class="page-link" href="../Reportes/MedicosMayorExamenesRequeridosA.jsp">Siguiente</a>
              </li>
            </ul>
        </nav>
