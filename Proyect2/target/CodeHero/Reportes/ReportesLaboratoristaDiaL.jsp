<%-- 
    Document   : ReportesLaboratoristaDiaL
    Created on : Oct 4, 2020, 10:37:44 AM
    Author     : camran1234
--%>
...
<html>
    <head>
        ...
        <title> Reporte Carga del dia Laboratorista Page</title>
    </head>
    <body>
        <h1>Examenes Del Turno</h1>
        ...
        <table class="table table-borderless table-dark">
          ...
          <tbody>
              <%
                  ...
                  ArrayList<String> examenesPendientes = new LaboratoristaQuery().ReporteExamenesTurno(codigoLaboratorista);
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              ...
              <li class="page-item">
                <a class="page-link" href="../Reportes/ReporteUtilizacionL.jsp">Anterior</a>
              </li>
              ...
              <li class="page-item disabled">
                <a class="page-link" href="../Reportes/ReportesLaboratoristaDiaL.jsp" aria-disabled="true" >Anterior</a>
              </li>
            </ul>
        </nav>
