<%-- 
    Document   : ReporteFechasCargadasL
    Created on : Oct 4, 2020, 10:42:08 AM
    Author     : camran1234
--%>
...
<html>
    <head>
        ...
        <title>Laboratorista Fechas Cargadas Page</title>
    </head>
    <body>
        <h1>Fechas Mas Cargadas Laboratorista (MAX=10)</h1>
        ...
        <table class="table table-borderless table-dark">
          ...
          <tbody>
              <%
                  ...
                  ArrayList<String> examenesPendientes = new LaboratoristaQuery().ReporteFechasMasOcupadas(codigoLaboratorista);
                  if(examenesPendientes!=null){
                    ...
                    for(int indexResultados=0;indexResultados<examenesPendientes.size();indexResultados++){
                        ...
                        <%
                        if(((indexResultados+1)%5==0) && (indexResultados != (examenesPendientes.size()-1)) && (indexResultados!=0)){
                        %>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              ...
              <li class="page-item">
                <a class="page-link" href="../Reportes/ReporteExamenesRealizadosDiaL.jsp">Anterior</a>
              </li>
              ...
              <li class="page-item">
                <a class="page-link" href="../Reportes/ReporteUtilizacionL.jsp">Siguiente</a>
              </li>
            </ul>
        </nav>
