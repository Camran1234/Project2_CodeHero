<%-- 
    Document   : MedicosMayorExamenesRequeridosA
    Created on : Oct 4, 2020, 1:33:07 PM
    Author     : camran1234
--%>
...
<html>
    ...
    <body>
        <h1>Medicos Con Mayor Examenes Requeridos<h1>
        
        <form method="get" action="../Reportes/MedicosMayorExamenesRequeridosA.jsp">        
        ...
        <table class="table table-borderless table-dark">
          ...
          <tbody>
              <%
                  ...
                  ArrayList<String> medicosInformes = new AdministradorQuery().ReporteMedicoMayorExamenesDemandados(fechaInicio, fechaFinal);
                  if(medicosInformes!=null){
                    ...
                    for(int indexResultados=0;indexResultados<medicosInformes.size();indexResultados++){
                        ...
                        <%
                        if(((indexResultados+1)%5==0) && (indexResultados != (medicosInformes.size()-1)) && (indexResultados!=0)){
                        %>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              ...
              <li class="page-item">
                <a class="page-link" href="../Reportes/MedicosExamensMasDemandadosA.jsp">Anterior</a>
              </li>
              ...
              <li class="page-item"><a class="page-link" href="../Reportes/MedicosMayorIngresoPacientesA.jsp">5</a></li>
              <li class="page-item"><a class="page-link" href="../Reportes/MedicosMenosSolicitadosA.jsp">6</a></li>
              <li class="page-item">
                <a class="page-link" href="../Reportes/MedicosMayorIngresoA.jsp">Siguiente</a>
              </li>
            </ul>
        </nav>
