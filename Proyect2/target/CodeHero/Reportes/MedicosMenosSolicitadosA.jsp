<%-- 
    Document   : MedicosMenosSolicitados
    Created on : Oct 4, 2020, 1:32:13 PM
    Author     : camran1234
--%>
...
<html>
    <head>
        ...
        <title>Medicos Menos Concurridos Page</title>
    </head>
    <body>
        <h1>Medicos Menos Solicitados<h1>
        
        <form method="get" action="../Reportes/MedicosMenosSolicitadosA.jsp">        
        ...
        <table class="table table-borderless table-dark">
          ...
          <tbody>
              <%
                  ...
                  ArrayList<String> medicosInformes = new AdministradorQuery().ReporteMenorConcurrenciaDoctoresCitas(fechaInicio, fechaFinal);
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              ...
              <li class="page-item">
                <a class="page-link" href="../Reportes/MedicosMayorIngresoPacientesA.jsp" >Anterior</a>
              </li>
              ...
              <li class="page-item disabled">
                <a class="page-link" href="../Reportes/MedicosMenosSolicitadosA.jsp" aria-disabled=""true">Siguiente</a>
              </li>
            </ul>
        </nav>
